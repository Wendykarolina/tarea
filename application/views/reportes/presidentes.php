<div class="row">
  <div class="col-md-12 text-center">
    <h1> <b> MAPA DE LOS CANDIDATOS A LA PRESIDENCIA DEL ECUADOR</b> </h1>
  </div>
</div>
<div class="row">
        <div class="col-md-12 text-center">
...
<!-- <div class="row">
        <div class="col-md-12 text-center">
          <img src="https://media.tenor.com/0k722lIHfNUAAAAC/rafael-correa.gif" alt="" height="350",width="300">
          <style>
      img {
        border-radius: 10px;
      }
...
<div class="container">
		...
		<script type="text/javascript">
  		...
  		<?php if($candidato1): ?>
  		<?php foreach ($candidato1 as $lugarTemporal): ?>
